"""
This script will prepare source data as parquet files
"""
import functools
import os
import csv
...
CDS_DEFAULT_UNLOCATABLE_POINTS_CSV_PATH = (
    SOURCES_DIRECTORY + '/default_unlocatable_points.csv'
)
...
def write_parquet(
    ...
    Parameters:
        ...
        - data ([dict]|pandas.DataFrame):
          ...
          Either an iterable of dictionary instances, or a data frame.
    """
